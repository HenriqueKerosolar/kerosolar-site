  ...
  return (
    <section className="py-16">
      <div className="container-px">
        <div className="grid items-center gap-10 overflow-hidden rounded-3xl bg-gradient-to-br from-brand-700 to-brand-900 p-8 text-white sm:p-12 lg:grid-cols-2">
          <div>
            <p className="text-sm font-semibold uppercase tracking-wider text-sun-400">
              E-book gratuito
            </p>
            <h2 className="mt-2 text-3xl font-bold sm:text-4xl">Anti-Cilada Solar</h2>
            <p className="mt-1 text-sm font-medium uppercase tracking-wide text-brand-200">
            ...
            <div className="mt-7 flex flex-wrap gap-3">
              <a
                ...
                className="inline-flex items-center gap-2 rounded-full bg-sun-500 px-6 py-3 font-semibold text-brand-900 transition hover:bg-sun-400"
              >
                <DownloadIcon />
          ...
          <div className="flex justify-center lg:justify-end">
            <div className="rotate-2 transition duration-500 hover:rotate-0">
              <Image
                ...
                width={760}
                height={1134}
                className="h-auto w-48 rounded-xl shadow-2xl ring-1 ring-white/10 sm:w-56"
              />
            </div>
          </div>
        </div>
...
function CheckIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" className="mt-0.5 shrink-0 text-sun-400" aria-hidden>
