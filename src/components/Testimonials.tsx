  ...
  return (
    <section className="bg-brand-50 py-16 sm:py-20">
      <div className="container-px">
        ...
        <div
          className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3 transition-opacity duration-400"
          ...
          <div className="mt-8 flex justify-center gap-2">
            {Array.from({ length: totalPages }).map((_, i) => (
              <button
                ...
                className={`h-2 rounded-full transition-all duration-300 ${i === page ? "w-6 bg-sun-500" : "w-2 bg-brand-200 hover:bg-brand-400"}`}
              />
            ))}
          </div>
        )}
